...
<%if(session.getAttribute("username")!=null)
	...
	PreparedStatement ps=con.prepareStatement("select * from rohit.register where dept='Manager' and status='Approved'");
...
<div id="wrap">
  ...
  <div id="content-wrap">
	...
	<table>
	<tr>
	<th colspan="2">Fname</th>
	<th colspan="2">Lname</th>
	...
	<td colspan="2"><%=rs.getString(11)%></td>
	<td colspan="2"><%=rs.getString(14)%></td>
	<td colspan="2"><a href="delete.jsp?email=<%=rs.getString(5)%>"><button type="submit">Delete</button></a>
	</td>
	</tr>
	<%} %>
	</table>
