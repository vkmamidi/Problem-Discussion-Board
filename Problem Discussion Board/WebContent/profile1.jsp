...
<div id="wrap">
  <div id="header">
    ...
    <div id="menu">
      <ul>
             ...
             <li><a href="Viewuser1.jsp">View User</a></li>
  ...
  <div id="content-wrap">
    ...
    <div id="main"> <a name="TemplateInfo"></a>
      <div class="box">
        <h1>Need help?</h1>
        <p>We&rsquo;re more than just a free IT management app &ndash; we're a community whose users stick together (and celebrate bacon and zombies)! At over 5 million IT pros strong, The MS ANSWERS a place where IT pros trade tech tips, show off their awesome projects, share real-world advice from the IT trenches&hellip; and have a laugh. Plus, experts from tech vendors are there too, talkin' shop and answering IT questions. Ready to join in?
        Helpful or Solved. The question remains open to receiving answers till the response is marked as Solved. Click on a question to view the responses.</p>
      </div>
      <a name="SampleTags"></a>
      <h1>&nbsp;</h1>
