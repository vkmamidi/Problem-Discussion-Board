...
PreparedStatement ps=con.prepareStatement("select * from rohit.question");
...
<td colspan="2" align="center"><a href="Answer.jsp?ques=<%=rs.getString(2)%>"><button type="submit">Answer</button></a></td>
</tr>		
		<%} %>
		</table>
