...
String sql="select * from rohit.register where emailid=?";
    ...
    <div id="menu">
      <ul>
        <li><a href="index.jsp">Home</a></li>
             <li><a href="#"><label onclick="showCustomer(this.value)">All Questions |</label></a></li>
		   <li><a href="#"><label onclick="showCus(this.value)">My Questions</label></a></li>
    ...
    <div id="main"> <a name="TemplateInfo"></a>
      <div class="box">
       <center>
		...
		<h1>&nbsp;</h1>
		<h1>User Profile</h1>
		<form method="post" action="UpdateServlet" name="registration" onsubmit="return formValidation()">
