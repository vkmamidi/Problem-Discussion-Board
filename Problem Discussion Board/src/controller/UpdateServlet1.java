...
public class UpdateServlet1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="update rohit.register set(fname,lname,contact,address,state,city,password,dob,ques,ans)=(?,?,?,?,?,?,?,?,?,?)where emailid=? and dept='Manager'";
		String sql1="update rohit.login set(password,ques,ans)=(?,?,?)where email=? and dept='Manager'";
		...
		if(fname.equals("")||lname.equals("")||contact.equals("")||address.equals("")||passwrd.equals("")||password1.equals("")||dob.equals(""))
		{
			...
			getServletContext().getRequestDispatcher("/updateM.jsp").include(request, response);
		}
