...
import javax.mail.internet.MimeMessage;
	...
	public class PasswordMail {
		...
		public boolean sendMail(String to,String generatedPassword) throws MessagingException
		{
			...
			String username="rohitmittal1802@gmail.com";//emailid
			String password="";// emailid password
			String from="rohitmittal1802@gmail.com";// email from which u have to send
			String subject="Reset Password";
			
			String link="http://localhost:8080/MVC/resetpassword.jsp";
